...
namespace BulletHell
{
    ...
    public abstract class ProjectileEmitterBase : MonoBehaviour
    {
        ...
        [Range(0.01f, 2f)] public float Scale = 1;
        public Color[] Colors;
        public Color Color => Colors[UnityEngine.Random.Range(0, Colors.Length)];

        [Foldout("General", true)]
        [Tooltip("Time <-10 will never destroy")]
        public float TimeToLive = 5;

        [Range(0.01f, 5f)] public float CoolOffTime = 0.1f;
        public bool AutoFire = true;
        public Vector2 Direction = Vector2.up;
        [Range(1f, 500f)] public float Speed = 1;
        ...
        [ConditionalField(nameof(IsFixedTimestep)), Range(0.01f, 0.2f)] public float FixedTimestepRate = 0.01f;
        ...
        protected RaycastHit2D[] resultHit = new RaycastHit2D[10];
        // For cull check
        ...
        #region Public===============================================
        //protected void HitDameEnemy(Enemy enemy, float damage, int id, string hautoID, float timeCanHitAgain = 1f)
        //{
        //    //if (enemy != null && enemy.dataAnim != null)
        //    //{


        //    //    TuTruongEffect tuTruongEffect = new TuTruongEffect();
        //    //    tuTruongEffect.Init(timeCanHitAgain,
        //    //        () => { enemy.LstEffectCountDown.UnRegister(tuTruongEffect, id.ToString() + hautoID); }
        //    //        );
        //    //    if (enemy.LstEffectCountDown.CheckExistEffect(id.ToString() + hautoID))
        //    //    {
        ...
        //    //        var hp = enemy.transform.gameObject.GetComponent<IHealth>();
        //    //        if (hp != null)
        //    //        {

        //    //            hp.TakeDame(damage);
        //    //            DamagePanel.Instance.SpawnDamageShow(enemy.transform.position, damage);
        //    //            if (hp.Health <= 0)
        //    //            {
        //    //                enemy.Dead();
        //    //            }
        //    //            enemy.LstEffectCountDown.Register(tuTruongEffect, id.ToString() + hautoID);
        //    //        }
        ...
        public void ClearAllProjectiles()
        {
            for (int i = 0; i < ActiveProjectileIndexes.Length; i++)
            {
                ...
                Pool<ProjectileData>.Node node = Projectiles.GetNode(ActiveProjectileIndexes[i]);
                ReturnNode(node);
        ...
        protected virtual void UpdateProjectiles(float tick)
        {
            ...
            for (int i = 0; i < PreviousActiveProjectileIndexes.Length - 1; i++)
            {
                ...
                Pool<ProjectileData>.Node node = Projectiles.GetNode(PreviousActiveProjectileIndexes[i]);
